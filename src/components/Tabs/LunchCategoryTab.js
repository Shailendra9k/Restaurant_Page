        ...
        <TabPanel value={value} index={0}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} xl={12} md={12}>
              <Paper className={classes.paper} elevation={0}>
              <p>Note: All lunch menu options include basmati rice, yoghurt sauce, mint sauce and Nan bread. Coffee or Nepalese tea as a
                dessert.</p>
              </Paper>
            </Grid>
          </Grid>
...
export default LunchCategoryTab;
